    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="container bg-purple-100 rounded-lg p-8">
                ...
                <div class="container">            
                    <form action="<?php echo e(route('cestas_personal.actualizar', ['id' => $cesta->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $elementosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elemento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="checkbox" id="elemento<?php echo e($elemento->id); ?>" name="elementos[]" value="<?php echo e($elemento->id); ?>" class="text-purple-600 border rounded focus:outline-none focus:border-purple-500" <?php echo e($cesta->elementos->contains($elemento) ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\Users\Usuario\Desktop\Docker compose\proyecto_laravel\fruteriaHermanasBriales\resources\views/editarcesta.blade.php ENDPATH**/ ?>