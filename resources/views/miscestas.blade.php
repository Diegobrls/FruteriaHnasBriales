                ...
                @foreach ($cestasPersonal as $cestas)
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <select name="elementos_{{ $cestas->id }}" id="elementos_{{ $cestas->id }}" class="mt-2 block w-full px-4 py-2 text-gray-700 border rounded-lg focus:outline-none focus:border-purple-500">
                                <option value=""></option>
                                @foreach ($cestas->elementos as $elemento)
