                ...
                @foreach ($cestasPersonal as $cestas)
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <p class="text-gray-700 dark:text-gray-300">Cantidad: {{ $cestas->cantidad_elementos }}</p>
                            ...
                            <a href="{{ route('cestas_personal.editar', ['cestaId' => $cestas->id]) }}" class="mt-4 font-bold py-2 px-4">Editar Cesta</a>
                        </div>
                    </div>
                @endforeach
            </div>
